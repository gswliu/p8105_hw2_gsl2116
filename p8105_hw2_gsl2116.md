...
Be sure to note the number of observations in both resulting datasets, and give examples of key variables. What was the median number of sports balls in a dumpster in 2016?
...
``` r
mrtrash_data["year" == 2016, median("sports_balls")]
```

    ## # A tibble: 0 x 1
    ## # ... with 1 variable: sports_balls <int>
