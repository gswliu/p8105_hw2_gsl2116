...
There are 404 unique locations included in the dataset. There are `nrow(distinct(brfss_data, locationabbr))` states (plus the District of Columbia) represented. The state that is observed the most is NJ. The median of the “Excellent” response value in 2002 is 23.6.

### Graphs

#### “Excellent” response values in 2002
